...
public final class Customer {
    ...
    private final @NotNull Pendencies pendencies;
    ...
    public boolean equals(@Nullable Object object) {
        ...
        @NotNull Customer customer = (Customer) object;
        return id == customer.id && Objects.equals(email, customer.email) && Objects.equals(cpf, customer.cpf);
    }
